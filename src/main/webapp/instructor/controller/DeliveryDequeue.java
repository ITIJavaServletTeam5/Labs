 ...
 * @author root
 */
@WebServlet(name = "DeliveryDequeue", urlPatterns = {"/instructor/view/deliverydequeue"})
public class DeliveryDequeue extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DeliveryqueueId dqi = new DeliveryqueueId(labIdLong, traineeIdLong);
